...
use ac_service::config::{
	BasePath, Configuration, ExtTransport, KeystoreConfig, NetworkConfiguration,
	NodeKeyConfig, OffchainWorkerConfig, PrometheusConfig, Role, RpcMethods,
	TaskExecutor, TelemetryEndpoints, WasmExecutionMethod,
};
use ac_service::TracingReceiver;
...
pub trait CliConfiguration<DCV: DefaultConfigurationValues = ()>: Sized {
	...
	fn create_configuration<C: SubstrateCli>(
		...
		let config_dir = base_path.config_dir("default");
