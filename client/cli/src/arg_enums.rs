...
impl Into<ac_service::config::WasmExecutionMethod> for WasmExecutionMethod {
	fn into(self) -> ac_service::config::WasmExecutionMethod {
		match self {
			WasmExecutionMethod::Interpreted => {
				ac_service::config::WasmExecutionMethod::Interpreted
			}
			#[cfg(feature = "wasmtime")]
			WasmExecutionMethod::Compiled => ac_service::config::WasmExecutionMethod::Compiled,
...
impl Into<ac_service::config::RpcMethods> for RpcMethods {
	fn into(self) -> ac_service::config::RpcMethods {
		match self {
			RpcMethods::Auto => ac_service::config::RpcMethods::Auto,
			RpcMethods::Safe => ac_service::config::RpcMethods::Safe,
			RpcMethods::Unsafe => ac_service::config::RpcMethods::Unsafe,
		}
	}
}
