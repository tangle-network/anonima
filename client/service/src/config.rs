...
// };
pub use ac_network::Multiaddr;
pub use ac_network::config::{ExtTransport, MultiaddrWithPeerId, NetworkConfiguration, Role, NodeKeyConfig};
...
impl Configuration {
	...
	pub fn protocol_id(&self) -> ac_network::config::ProtocolId {
		...
		// 	None => {
				...
				// );
		let protocol_id_full =	crate::DEFAULT_PROTOCOL_ID;
		// 	}
		// };
		ac_network::config::ProtocolId::from(protocol_id_full)
	}
}
